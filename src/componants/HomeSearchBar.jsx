...
const HomeSearchBar = ({
  ...
  return (
    ...
    <div className="Btn">
      <button className="text-orange-500 border-orange-500  border-2 hover:text-white hover:bg-orange-500 duration-300 px-6 rounded-lg py-1 w-full md:w-auto"> Search</button>
    </div>
